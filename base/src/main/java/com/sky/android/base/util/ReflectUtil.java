...
package com.sky.android.base.util;
...
public class ReflectUtil {
    ...
    private final static String TAG = "ReflectUtil";
    ...
    public static Class<?> findClass(String className) {
        return findClass(className, getThreadClassLoader());
    }
...
//                continue;
    ...
    public static Object getObjectFieldQuietly(Object obj, String fieldName) {

        if (obj == null || fieldName == null) return null;

        return catchHandler(() -> getObjectField(obj, fieldName));
    }
    ...
    public static Object callMethodQuietly(Object obj, String methodName, Object... args) {

        if (obj == null || methodName == null) return null;

        return catchHandler(() -> callMethod(obj, methodName, args));
    }
    ...
    public static <T> T catchHandler(OnCatch<T> onCatch) {
        return catchHandler(onCatch, null);
    }

    public static <T> T catchHandler(OnCatch<T> onCatch, T defValue) {
        try {
            return onCatch.onHandler();
        } catch (Throwable tr) {
            Alog.e(TAG, tr);
        }
        return defValue;
    ...
    public interface OnCatch<T> {

        T onHandler() throws Throwable;
    }
}
